...
function mind_nature_scripts() {
	wp_enqueue_style( 'mind_nature-style', get_stylesheet_uri(), array(), mind_nature_VERSION );
  ...
  wp_register_script( 'jquery', "https://code.jquery.com/jquery-3.4.1.min.js", array(), '3.4.1',true );
	...
	wp_enqueue_script( 'mind_nature-navigation', get_template_directory_uri() . '/js/navigation.js', array(), mind_nature_VERSION, true );
